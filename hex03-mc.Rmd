...
Solution
========
  The flow rate of the cold stream is given by $m_C \; = \; \frac{q}{C_C\times (T_{Cold}out - T_{Cold}in)}$ where $q \; = \; m_H\times C_H\times (T_{Hot}in - T_{Hot}out)$.
